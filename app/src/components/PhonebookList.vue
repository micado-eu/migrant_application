   ...
   <div class="row" style="text-align:center;margin:0 auto; max-width:750px">
    ...
    <q-list>
      <q-scroll-area  id="scroll" ref="scrollArea" style="height: 540px; max-width: 100%;">
       ...
       <div class="col-1" style="width:5%; padding-top:10px">
    <q-list >
      <a clickable style="text-decoration:none; font-size:8px; font-family: 'Nunito Sans', sans-serif; color:black;font-weight:700" v-for="letter in letters" :id="letter" :key="letter" @click="searchByLetter($event)" href="javascript:void(0)">
