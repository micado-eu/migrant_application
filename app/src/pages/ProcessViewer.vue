  ...
  <div>
    ...
    <div v-else class="container">
      ...
      <div class="row">
        <div class="col">
          <q-scroll-area vertical id="scroll" class="bg-grey-1">
            <vue-mermaid
              class="center"
              :nodes="mermaid"
              :config="merconf"
...
export default {
  ...
  methods: {
    ...
    changeHotspot(value) {
      ...
      this.fetchDocumentTypePicturesById({
        id: value.pic_id,
        defaultLang: this.$defaultLang,
        currentLang: this.$userLang,
      }).then(() => {
