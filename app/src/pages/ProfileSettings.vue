    ...
    <div v-else>
      <div class="div-1">
        ...
        <div class="">
          ...
          <div
            class="row"
            style="justify-content: center; padding-bottom: 20px"
          >
            <q-btn
              :icon="'img:statics/icons/Icon - Camera icon.svg'"
              class="button-picture"
              unelevated
              no-caps
              rounded
              :label="$t('profile.change_pic')"
              @click="
          ...
          <div class="q-px-md">
            <div class="col-8 input">
              <q-input
                ...
                standout
                outlined
                v-model="the_user.date_of_birth"
              >
                <TalkingLabel
                  :text="$t('profile.dob')"
                  :icon_style="'margin-top:7px; margin-left:10px'"
          ...
          <div class="q-px-md">
            <div v-if="!editing" class="col-8 input">
              <q-btn
                class="button-edit"
                :icon="'img:statics/icons/Icon - edit.svg'"
                unelevated
                no-caps
                rounded
                :label="$t('button.edit')"
            ...
            <div v-else class="col-8 input">
              <q-btn
                ...
                :icon="'img:statics/icons/Icon - X (cancel).svg'"
                unelevated
                no-caps
                rounded
          ...
          <q-dialog v-model="change_pass">
            <q-card class="q-pa-md" style="padding-top: 0px">
              <div
                class="q-pa-md"
                style="text-align: center; padding_bottom: 30px"
              >
                <TalkingLabel
                  class="option"
                  style="width: 100%"
          ...
          <q-dialog v-model="pass_changed">
            <q-card class="q-pa-md" style="padding-top: 0px">
              <div style="padding-top: 50px; text-align: center">
                <q-icon
                  size="150px"
                  :name="'img:statics/icons/Icon - Round checkmark blue.svg'"
                />
                <TalkingLabel
                  class="option_2"
                  style="width: 100%"
          ...
          <div v-if="users.length > 0">
            ...
            >
              ...
              <div style="text-align: right; flex-shrink: 0">
                <div class="row" style="justify-content: right">
                  <q-checkbox
                    :disable="!edit_preferences"
                    color="accent"
                    v-model="
                      preferences.filter((pref) => {
                        return pref.id == user_top.id;
                      })[0].active
                    "
                  />
                  <TalkingLabel
            ...
            <div v-if="!edit_preferences" class="col-8 input">
              <q-btn
                ...
                rounded
                :label="$t('button.edit')"
                @click="edit_preferences = !edit_preferences"
              />
            </div>
            <div v-else class="col-8 input">
              <q-btn
...
export default {
  ...
  methods: {
    ...
    editPass() {
      ...
      var pass_payload = JSON.stringify({
          ...
          actions: [
            {
              ...
              handler: () => {
                if (this.user_pic_orig == null) {
                  ...
                  //edit the picture
                  this.editUserPic({
                    picture: this.user_picture.picture,
                    id: this.the_user.picture_id,
                  });
                  this.user_pic_orig = this.the_user.picture;
                  console.log(this.user_pic_orig == this.the_user.picture);
                }
