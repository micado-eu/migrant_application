...
export function logout (store) {
  ...
  let aut_url = 'https://' + this._vm.$envconfig.identityUrl + '/oidc/logout?id_token_hint=' + the_token.token.id_token + '&post_logout_redirect_uri=https://migrants.micadoproject.eu'
